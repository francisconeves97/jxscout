/******/ (function (modules) {
  ...
  /******/ function jsonpScriptSrc(chunkId) {
    /******/ return (
      ...
      ({}[chunkId] || chunkId) +
      ".js?id=" +
      { 0: "c523e16615500fabc254" }[chunkId] +
      ""
    );
    /******/
  }
  ...
  \***********************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        var e = __webpack_require__(
          ...
          t = {
            ...
            render: function (t, r) {
              ...
              return t(
                "a",
                Object.assign({}, i, {
                  attrs: Object.assign({}, i.attrs, { href: n.href }),
                  on: Object.assign({}, i.on || {}, {
                    click: function (t) {
                      i.on && i.on.click && i.on.click(t),
                        e.shouldIntercept(t) &&
                          (t.preventDefault(),
                          e.Inertia.visit(n.href, {
                            data: n.data,
                            method: n.method,
                            replace: n.replace,
            ...
            created: function () {
              ...
              if (this.$options.remember) {
                Array.isArray(this.$options.remember) &&
                  ...
                  "string" == typeof this.$options.remember &&
                    (this.$options.remember = {
                      data: [this.$options.remember],
                    }),
                  "string" == typeof this.$options.remember.data &&
                    (this.$options.remember = {
                ...
                this.$options.remember.data.forEach(function (i) {
                  void 0 !== n && void 0 !== n[i] && (t[i] = n[i]),
                    t.$watch(
                      i,
                      function () {
                        e.Inertia.remember(
                          t.$options.remember.data.reduce(function (e, r) {
                            var n;
          ...
          i = {
            ...
            data: function () {
              return { component: null, props: {}, key: null };
            },
            created: function () {
              var t = this;
              (n = this),
                e.Inertia.init({
                  ...
                  updatePage: function (e, r, n) {
                    var i = n.preserveState;
                    (t.component = e),
                      (t.props = t.transformProps(r)),
                      (t.key = i ? t.key : Date.now());
                  },
                });
            },
            render: function (e) {
              if (this.component)
                return e(this.component, { key: this.key, props: this.props });
            },
            install: function (i) {
              Object.defineProperty(i.prototype, "$inertia", {
                get: function () {
                  return e.Inertia;
                },
              }),
                Object.defineProperty(i.prototype, "$page", {
                  get: function () {
                    return n.props;
                  },
                }),
                i.mixin(r),
                i.component("InertiaLink", t);
            },
          };
        (exports.InertiaApp = i), (exports.InertiaLink = t);
          ...
          n = {
            ...
            show: function (e) {
              ...
              (n.style.backgroundColor = "white"),
                ...
                n.contentWindow.document.write(i.outerHTML),
          ...
          start: function () {
            ...
            clearTimeout(this.delay),
              (this.delay = setTimeout(function () {
                (e.loading = !0), i.set(0), i.start();
              }, 250));
          },
          increment: function () {
            this.loading && i.inc(0.4);
          },
          stop: function () {
            clearTimeout(this.delay),
              this.loading && (i.done(), (this.loading = !1));
          },
        };
        (exports.Inertia = {
          ...
          init: function (e) {
            var t = e.initialPage,
              i = e.updatePage;
            (this.resolveComponent = e.resolveComponent),
              (this.updatePage = i),
              window.history.state && "back_forward" === this.navigationType()
                ? this.setPage(window.history.state)
                : window.sessionStorage.getItem("inertia.hardVisit")
                ? (window.sessionStorage.removeItem("inertia.hardVisit"),
                  this.setPage(t, { preserveState: !0 }))
                : ((t.url += window.location.hash), this.setPage(t)),
          ...
          isInertiaResponse: function (e) {
            return e && e.headers["x-inertia"];
          },
          cancelActiveVisits: function () {
            this.cancelToken && this.cancelToken.cancel(this.cancelToken),
              (this.cancelToken = t.CancelToken.source());
          },
          ...
          visit: function (e, i) {
            ...
            var d = i.replace;
            void 0 === d && (d = !1);
            var c = i.preserveScroll;
            void 0 === c && (c = !1);
            var l = i.preserveState;
            void 0 === l && (l = !1);
            var h = i.only;
            void 0 === h && (h = []), o.start(), this.cancelActiveVisits();
            var u = this.createVisitId();
            return t({
              method: a,
              url: e.toString(),
              data: "get" === a.toLowerCase() ? {} : r,
              params: "get" === a.toLowerCase() ? r : {},
              ...
              .then(function (e) {
                if (s.isInertiaResponse(e)) return e.data;
                n.show(e.data);
              })
              .catch(function (e) {
                if (!t.isCancel(e))
                  return 409 === e.response.status &&
                    e.response.headers["x-inertia-location"]
                    ? (o.stop(),
                      s.hardVisit(!0, e.response.headers["x-inertia-location"]))
                    : s.isInertiaResponse(e.response)
                    ? e.response.data
                    : e.response
                    ? (o.stop(), void n.show(e.response.data))
                    : Promise.reject(e);
              })
              .then(function (e) {
                if (e)
                  return (
                    h.length &&
                      (e.props = Object.assign({}, s.page.props, e.props)),
                    s.setPage(e, {
                      visitId: u,
                      replace: d,
                      preserveScroll: c,
          ...
          hardVisit: function (e, t) {
            window.sessionStorage.setItem("inertia.hardVisit", !0),
              e ? window.location.replace(t) : (window.location.href = t);
          },
          setPage: function (e, t) {
            var i = this;
            void 0 === t && (t = {});
            var n = t.visitId;
            void 0 === n && (n = this.createVisitId());
            var s = t.replace;
            void 0 === s && (s = !1);
            var a = t.preserveScroll;
            void 0 === a && (a = !1);
            var r = t.preserveState;
            return (
              void 0 === r && (r = !1),
              (this.page = e),
              o.increment(),
              Promise.resolve(this.resolveComponent(e.component)).then(
                function (t) {
                  n === i.visitId &&
                    ((i.version = e.version),
                    i.setState(e, s, r),
                    i.updatePage(t, e.props, { preserveState: r }),
                    i.setScroll(a),
                    o.stop());
                }
              )
                ...
                ? window.history.replaceState(
                    Object.assign(
                      ...
                      i && window.history.state
                        ? { cache: window.history.state.cache }
                        : {},
                      e
                    ),
                    "",
          ...
          replace: function (e, t) {
            return (
              ...
              this.visit(
                e,
                Object.assign({}, { preserveState: !0 }, t, { replace: !0 })
              )
            );
          },
          reload: function (e) {
            return (
              void 0 === e && (e = {}), this.replace(window.location.href, e)
            );
          },
          post: function (e, t, i) {
            return (
              ...
              this.visit(
                e,
                Object.assign({}, { preserveState: !0 }, i, {
                  method: "post",
                  data: t,
                })
              )
          ...
          delete: function (e, t) {
            return (
              void 0 === t && (t = {}),
              this.visit(e, Object.assign({}, t, { method: "delete" }))
            );
          },
          remember: function (e, t) {
            void 0 === t && (t = "default");
            var i = Object.assign({}, window.history.state);
            (i.cache = i.cache || {}), (i.cache[t] = e), this.setState(i);
          },
          restore: function (e) {
            if (
              (void 0 === e && (e = "default"),
              window.history.state.cache && window.history.state.cache[e])
            )
              return window.history.state.cache[e];
          },
        }),
    ...
    \***********************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        var map = {
          "./Home": ["./resources/js/Pages/Home.vue", 0],
          "./Home.vue": ["./resources/js/Pages/Home.vue", 0],
        };
    ...
    \*****************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! @inertiajs/inertia-vue */ "./node_modules/@inertiajs/inertia-vue/dist/index.js"
          );
        /* harmony import */ var _inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_0___default =
          /*#__PURE__*/ __webpack_require__.n(
            _inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_0__
          );
        ...
        vue__WEBPACK_IMPORTED_MODULE_1__["default"].use(
          _inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_0__["InertiaApp"]
        );
                ...
                props: {
                  ...
                  resolveComponent: function resolveComponent(name) {
                    return __webpack_require__(
                      "./resources/js/Pages lazy recursive ^\\.\\/.*$"
                    )("./".concat(name)).then(function (module) {
                      return module["default"];
                    });
                  },
                },
    ...
    \*************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        __webpack_require__(
          /*! /Users/Studio/Code/inertia-custom-root-view-test/resources/js/app.js */ "./resources/js/app.js"
        );
        module.exports = __webpack_require__(
          /*! /Users/Studio/Code/inertia-custom-root-view-test/resources/sass/app.scss */ "./resources/sass/app.scss"
        );
